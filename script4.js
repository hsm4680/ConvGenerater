function generateQuiz() {
    ...
    // API 요청
    fetch('https://proxy.cors.sh/https://clovastudio.stream.ntruss.com/testapp/v1/chat-completions/HCX-003', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'X-NCP-APIGW-API-KEY': '1IzboF2LvYV6qaFv6qSwx1Yy1VU4xmPQb0VaNRZV',
        'x-requested-with': 'XMLHttpRequest',
        'x-cors-api-key': 'temp_40a8fbd99c038f99c09f039bf29fb83d' // cors.bridged.cc API 키 추가
      },
