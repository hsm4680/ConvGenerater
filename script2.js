function generateQuiz() {
    ...
    // API 요청
    fetch('https://cors-anywhere.herokuapp.com/https://clovastudio.stream.ntruss.com/testapp/v1/chat-completions/HCX-003?messages=' + encodeURIComponent(JSON.stringify(data.messages)) + '&temperature=' + data.temperature + '&repetitionPenalty=' + data.repetitionPenalty + '&maxTokens=' + data.maxTokens + '&topP=' + data.topP, {
      method: 'GET',
      headers: {
